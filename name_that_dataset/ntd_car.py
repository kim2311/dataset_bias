...
train_COCO = '/local/b/cam2/data/car/COCO/'
train_ImageNet = '/local/b/cam2/data/car/ImageNet/'
train_Pascal = '/local/b/cam2/data/car/VOC/'
train_Sun = '/local/b/cam2/data/car/SUN/'
train_kitti = '/local/b/cam2/data/car/KITTI/'
...
for j in model:
    ...
    '''
    X_train_m = np.vstack((coco_train, imagenet_train, pascal_train, sun_train, kitti_train)).astype(np.float64) #, mix_train)).astype(np.float64)
    X_test_m = np.vstack((coco_test, imagenet_test, pascal_test, sun_test, kitti_test)).astype(np.float64) #, mix_test)).astype(np.float64)
